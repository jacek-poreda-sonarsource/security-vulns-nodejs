...
function search(query) {
    ...
    const q = "SELECT * FROM products WHERE name ILIKE $1 OR description ILIKE $1;";
...
function purchase(cart) {
    ...
    const q = "INSERT INTO purchases(mail, product_name, user_name, product_id, address, phone, ship_date, price) VALUES($1, $2, $3, $4, $5, $6, $7, $8)";
